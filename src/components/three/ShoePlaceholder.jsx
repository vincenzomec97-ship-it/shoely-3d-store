...
function ShoePlaceholder({
  ...
  const upperShape = useMemo(() => {
    ...
    shape.quadraticCurveTo(0.88, 1.72, 1.2, 1.65)
    shape.lineTo(1.7, 1.48)
    shape.quadraticCurveTo(1.92, 1.38, 1.96, 1.05)
  ...
  return (
    <group
      ...
      {...pointerHandlers}
    >
      <RoundedBox args={[4.55, 0.5, 1.3]} radius={0.22} smoothness={3} position={[0, -0.68, 0]}>
